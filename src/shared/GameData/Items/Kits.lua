return {
	...
	ruby = {
		name = "Ruby Refining Kit",
		description = "A refining kit designed to extract rubies and other precious gems from rubble with higher efficiency.",
		color = Color3.fromRGB(255, 0, 127),

		mallet = "ruby_mallet",
		container = "ruby_container",
		tray = "ruby_tray",
